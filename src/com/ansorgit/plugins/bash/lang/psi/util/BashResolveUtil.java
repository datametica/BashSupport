...
public final class BashResolveUtil {
    ...
    public static GlobalSearchScope varDefSearchScope(BashVar reference, boolean withIncludedFiles) {
        ...
        return null;//GlobalSearchScope.filesScope(referenceFile.getProject(), result);
    }
...
/*    *//**
     ...
     *
     *  reference       The variable to use as starting point
     *  resultProcessor The function called with each of the located definitions
     *//*
    ...
    public static PsiElement resolve(BashVar bashVar, boolean dumbMode, ResolveProcessor processor) {
        ...
        Collection<BashVarDef> varDefs = null;
