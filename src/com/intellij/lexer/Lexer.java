 ...
 *
 *  LexerBase for certain methods' implementation
 */
public abstract class Lexer {
   ...
   * that the value of initialState is the same as returned by { #getState()} method of this lexer at condition {@code startOffset=getTokenStart()}.
