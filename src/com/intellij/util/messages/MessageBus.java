 ...
 * <pre>
 * <ul>
 *   <li>allows to { #syncPublisher(Topic) push messages};</li>
 *   <li>
 *     allows to { #connect() create connections} for further { MessageBusConnection#subscribe(Topic, Object) subscriptions};
 *   </li>
 * </ul>
 * </pre>
 * <p/>
...
public interface MessageBus {
  ...
  /**
   * Messages buses can be organised into hierarchies. That allows facilities { Topic#getBroadcastDirection() broadcasting}.
   * <p/>
  ...
  /**
   * Allows to create new connection that is not bound to any { Disposable}.
   *
   ...
   * will be automatically { MessageBusConnection#dispose() released} if given { Disposable disposable parent} is collected.
   *
   ...
   * <ol>
   *   <li>
   *     Messaging clients create new { MessageBusConnection connections} within the target message bus and
   *     { MessageBusConnection#subscribe(Topic, Object) subscribe} to the target { Topic topics};
   *   </li>
   *   <li>
   *     Every time somebody wants to send a message for particular topic, he or she calls current method and receives object
   *     that conforms to the { Topic#getListenerClass() business interface} of the target topic. Every method call on that
   *     object is dispatched by the messaging infrastructure to the subscribers.
   *     { Topic#getBroadcastDirection() broadcasting} is performed if necessary as well;
   *   </li>
   * </ol>
   * </pre>
   * <p/>
   ...
   * @param <L>   { Topic#getListenerClass() business interface} of the target topic
  ...
  /**
   * @deprecated use { #syncPublisher(Topic)} instead
   */
  @NotNull
  @Deprecated
   ...
   * { #connect(Disposable) connections}.
   */
  void dispose();
}