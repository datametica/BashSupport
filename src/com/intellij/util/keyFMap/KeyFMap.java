...
/**
 * An immutable map optimized for storing few { Key} entries with relatively rare updates
 * To construct a map, start with { KeyFMap#EMPTY_MAP} and call { #plus} and { #minus}
 *
 * @author peter
 */
