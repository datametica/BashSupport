...
public class URLUtil {
  ...
  /**
   * @return if false, then the line contains no URL; if true, then more heavy { #URL_PATTERN} check should be used.
   */
  ...
  /**
   * Opens a url stream. The semantics is the sames as { URL#openStream()}. The
  ...
  /**
   * Checks whether local resource specified by {@code url} exists. Returns { ThreeState#UNSURE} if {@code url} point to a remote resource.
   */
  @NotNull
