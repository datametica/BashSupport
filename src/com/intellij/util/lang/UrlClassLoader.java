 ...
 * Should be constructed using { #build()} method.
 */
public class UrlClassLoader extends ClassLoader {
   ...
   * 
   *  #createCachePool()
   *  Builder#useCache(CachePool, CachingCondition)
   */
  public interface CachePool { }

  /**
   * A condition to customize the caching policy when using { CachePool}. This might be needed when a class loader is used on a directory
