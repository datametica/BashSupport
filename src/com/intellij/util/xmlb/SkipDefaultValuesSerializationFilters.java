...
/**
 * Please use { SkipDefaultsSerializationFilter} if state class doesn't implement "equals" (in Kotlin use data classes { http://kotlinlang.org/docs/reference/data-classes.html})
 */
