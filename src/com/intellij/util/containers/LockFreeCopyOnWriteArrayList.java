 ...
 * - non-cloneable, non-serializable, no-subList-method variant of { java.util.concurrent.CopyOnWriteArrayList}.
 * It generally is faster than COWAL in case of low write-contention.
 * (Note that it is not advisable to use COWAL in high write-contention code anyway, consider using { java.util.concurrent.ConcurrentHashMap}) instead)
 */
