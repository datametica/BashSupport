 ...
 * <em>optional</em> methods of the { Map} and { Iterator}
 * interfaces.
 * <p/>
 * <p>Like { Hashtable} but unlike { HashMap}, this class
 ...
 * ideally be side-effect-free. Bulk operations on { Entry}
 ...
 * @author Doug Lea
 * @since 1.5
 * @deprecated Use { ContainerUtil#newConcurrentMap()} instead
 */
@Deprecated
public final class ConcurrentHashMap<K, V> extends AbstractMap<K, V>
   ...
   * <p/>
   * <p>The view's {@code spliterator} reports { Spliterator#CONCURRENT},
   ...
   * directly instantiated. See { #values()}.
   */
   ...
   * { #entrySet()}.
   */
  private static final class EntrySetView<K, V> extends CollectionView<K, V, Entry<K, V>>
