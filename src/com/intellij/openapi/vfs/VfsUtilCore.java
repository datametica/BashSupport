...
public class VfsUtilCore {
  ...
  /**
   * Checks whether the <code>ancestor { VirtualFile}</code> is parent of <code>file
   * { VirtualFile}</code>.
   *
  ...
  /**
   * Converts VsfUrl info { URL}.
   *
   * @param vfsUrl VFS url (as constructed by { VirtualFile#getUrl()}
