...
public interface FileSystemInterface {
  ...
  /** Does NOT strip the BOM from the beginning of the stream, unlike the { VirtualFile#getInputStream()} */
  @NotNull
  InputStream getInputStream(@NotNull VirtualFile file) throws IOException;

  /** Does NOT add the BOM to the beginning of the stream, unlike the { VirtualFile#getOutputStream(Object)} */
  @NotNull
