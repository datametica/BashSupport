...
public class CharsetUtil {
  ...
  private static final Map<LanguageFileType, Boolean> ourSupportsCharsetDetection = new ConcurrentFactoryMap<LanguageFileType, Boolean>() {
    ...
    protected Boolean create(LanguageFileType fileType) {
      ...
      Class declaring1 = ReflectionUtil.getMethodDeclaringClass(ftClass, methodName,  VirtualFile.class, String.class);
      Class declaring2 = ReflectionUtil.getMethodDeclaringClass(ftClass, methodName,  VirtualFile.class, CharSequence.class);
  ...
  public static Charset extractCharsetFromFileContent(
    ...
    if (fileType instanceof LanguageFileType &&
      ...
      return ((LanguageFileType)fileType).extractCharsetFromFileContent( virtualFile, text);
    }
    return null;
  }
}
