 ...
 * asked to compute A for the second time. { RecursionGuard#doPreventingRecursion(Object, Computable)} does precisely this.
 *
 ...
 * { RecursionGuard#markStack()} and { RecursionGuard.StackStamp#mayCacheNow()}
 * for the advice.
 *
 *  RecursionGuard
