 ...
 * but register your object to be chained with a parent disposable via { com.intellij.openapi.util.Disposer#register(Disposable, Disposable)}.
 * If you're 100% sure that you should control disposion of your object manually,
 * do not call the { #dispose} method either. Use { com.intellij.openapi.util.Disposer#dispose(Disposable)} instead, since
