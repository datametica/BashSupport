...
public abstract class ResolveScopeManager {
  ...
  public static ResolveScopeManager getInstance() {
    return ServiceManager.getService(ResolveScopeManager.class);
  }

  @NotNull
  public static GlobalSearchScope getElementUseScope(@NotNull PsiElement element) {
    return getInstance().getUseScope(element);
  }
  ...
  public static GlobalSearchScope getElementResolveScope(@NotNull PsiElement element) {
    ...
    if (file != null) {
      return getInstance().getResolveScope(file);
    }
    return getInstance().getResolveScope(element);
  }
}
