...
public class DebugUtil {
  ...
  public static final boolean DO_EXPENSIVE_CHECKS = false;
   ...
   * identifying this transaction, and so will { com.intellij.psi.PsiInvalidElementAccessException} thrown when accessing such invalid
  ...
  public static String diagnosePsiDocumentInconsistency(@NotNull PsiElement element, @NotNull Document document) {
    ...
    PsiDocumentManager manager = PsiDocumentManager.getInstance();
