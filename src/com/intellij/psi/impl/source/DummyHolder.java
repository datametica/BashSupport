...
public class DummyHolder extends PsiFileImpl {
  ...
  public DummyHolder(TreeElement contentElement, PsiElement context) {
    this( contentElement, context, SharedImplUtil.findCharTableByTree(contentElement));
  }

  public DummyHolder(CharTable table, boolean validity) {
    this( null, null, table, Boolean.valueOf(validity), PlainTextLanguage.INSTANCE);
  }

  public DummyHolder(PsiElement context) {
    this( null, context, null);
  }

  public DummyHolder(@Nullable TreeElement contentElement, PsiElement context, @Nullable CharTable table) {
    this(contentElement, context, table, null, language(context, PlainTextLanguage.INSTANCE));
  }
  ...
  public DummyHolder(@Nullable TreeElement contentElement, @Nullable PsiElement context, @Nullable CharTable table, @Nullable Boolean validity, Language language) {
    super(TokenType.DUMMY_HOLDER, TokenType.DUMMY_HOLDER, new DummyHolderViewProvider());
    myLanguage = language;
  ...
  public DummyHolder(PsiElement context, CharTable table) {
    this(null, context, table);
  }

  public DummyHolder(final CharTable table, final Language language) {
    this(null, null, table, null, language);
  }

  public DummyHolder(final Language language, final PsiElement context) {
    this(null, context, null, null, language);
  }
  ...
  protected PsiFileImpl clone() {
    ...
    final DummyHolderViewProvider dummyHolderViewProvider = new DummyHolderViewProvider();
