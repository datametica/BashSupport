...
public abstract class CachingReference implements PsiReference {
  ...
  public PsiElement resolve(){
    return ResolveCache.getInstance().resolveWithCaching(this, MyResolver.INSTANCE, false, false);
  }
  ...
  public boolean isReferenceTo(final PsiElement element) {
    return false;//getElement().getManager().areElementsEquivalent(resolve(), element);
  }
