...
public abstract class SmartPointerManager {
  ...
  public static SmartPointerManager getInstance() {
    return ServiceManager.getService(SmartPointerManager.class);
  }
   ...
   * element.
   * @deprecated use { #createSmartPsiElementPointer(PsiElement)} instead
   * @param element the element to create a pointer to.
   * @return the smart pointer instance.
   */
