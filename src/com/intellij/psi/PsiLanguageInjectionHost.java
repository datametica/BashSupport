 ...
 * <ul>
 * <li>Implement { com.intellij.psi.LanguageInjector} to describe exact place where injection should occur.</li>
 * <li>Register injection in { com.intellij.psi.LanguageInjector#EXTENSION_POINT_NAME} extension point.</li>
 * </ul>
...
public interface PsiLanguageInjectionHost extends PsiElement {
   ...
   * in accordance with the host language syntax. The implementation may delegate to { com.intellij.psi.ElementManipulators#handleContentChange(PsiElement, String)}
   * if { com.intellij.psi.ElementManipulator} implementation is registered for this element class
  ...
  /**
   * @return { LiteralTextEscaper} instance which will be used to convert the content of this host element to the content of injected file
   */
  @NotNull
