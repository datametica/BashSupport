...
public abstract class PsiFileFactory {
  ...
  public static PsiFileFactory getInstance() {
    return null;//ServiceManager.getService(project, PsiFileFactory.class);
  }

  /**
   * Please use { #createFileFromText(String, com.intellij.openapi.fileTypes.FileType, CharSequence)},
