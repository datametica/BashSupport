...
public abstract class PsiReferenceService {
  ...
  /**
   * By default, return the same as { PsiElement#getReferences()}.
   ...
   * @param hints optional hints which are passed to { PsiReferenceProvider#acceptsHints(PsiElement, Hints)} and
   * { PsiReferenceProvider#acceptsTarget(PsiElement)} before the { com.intellij.patterns.ElementPattern} is matched, for performing
