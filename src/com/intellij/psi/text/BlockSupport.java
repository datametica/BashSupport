...
public abstract class BlockSupport {
  public static BlockSupport getInstance() {
    return ServiceManager.getService(BlockSupport.class);
  }
  ...
  public static final int INCREMENTAL_REPARSE_DEPTH_LIMIT = Registry.intValue("psi.incremental.reparse.depth.limit".toString());
