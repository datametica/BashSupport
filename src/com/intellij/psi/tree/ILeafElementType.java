...
/**
 * An additional interface to be implemented by { IElementType} instances to allow customizing how leaf AST elements are created
...
public interface ILeafElementType {
  ...
  /**
   * Invoked by { com.intellij.lang.PsiBuilder} to create a leaf AST node based of this type.
