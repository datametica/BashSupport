...
/**
 * A superclass for all element types for root AST nodes in a { com.intellij.psi.PsiFile}.
 */
public class IFileElementType extends ILazyParseableElementType {
  ...
  /**
   * Allows to construct file element types without registering them, as in { IElementType#IElementType(String, Language, boolean)}.
   */
