...
public class ILazyParseableElementType extends IElementType {
  ...
  protected ASTNode doParseContents(@NotNull ASTNode chameleon, @NotNull PsiElement psi) {
    ...
    PsiBuilder builder = PsiBuilderFactory.getInstance().createBuilder(chameleon, null, languageForParser, chameleon.getChars());
    PsiParser parser = LanguageParserDefinitions.INSTANCE.forLanguage(languageForParser).createParser();
