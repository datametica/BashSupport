 ...
 *  com.intellij.lang.ASTNode#getElementType()
 */
public class IElementType {
   ...
   * This is not default behavior and not recommended. A lot of other functionality (e.g. { TokenSet}) won't work with such element types.
   * Please use { #IElementType(String, Language)} unless you know what you're doing.
   */
   ...
   *
   *  IElementType#enumerate(Predicate)
   */
