...
public abstract class PsiDocumentManager {
   ...
   */
  public static PsiDocumentManager getInstance() {
    return null;//project.getComponent(PsiDocumentManager.class);
  }
   ...
   *  com.intellij.util.text.ImmutableCharSequence
   */
  @NotNull
   ...
   * the ones of { #getDocument(PsiFile)}. For uncommitted documents, the text is { #getLastCommittedText(Document)} and
   ...
   * and can be applied in the middle of a write action by calling { #doPostponedOperationsAndUnblockDocument}.
   *
