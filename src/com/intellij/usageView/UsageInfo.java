...
public class UsageInfo {
  ...
  public UsageInfo(@NotNull PsiElement element, int startOffset, int endOffset, boolean isNonCodeUsage) {
    ...
    SmartPointerManager smartPointerManager = null;//SmartPointerManager.getInstance(project);
  ...
  /**
   * @deprecated for the range in element use { #getRangeInElement} instead,
   *             for the whole text range in the file covered by this usage info, use { #getSegment()}
   */
  ...
  public Segment getSegment() {
    ...
    if (element instanceof PsiFile) {
      ...
      Document document = null;//PsiDocumentManager.getInstance(getProject()).getDocument((PsiFile)element);
      if (document != null) {
  ...
  public boolean equals(Object o) {
    ...
    SmartPointerManager smartPointerManager = SmartPointerManager.getInstance();
