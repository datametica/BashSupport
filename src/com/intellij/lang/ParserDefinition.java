...
public interface ParserDefinition {
   ...
   * range of the nodes.
   * <p><strong>It is strongly advised you return TokenSet that only contains { com.intellij.psi.TokenType#WHITE_SPACE},
   ...
   *
   *  ParserDefinition#spaceExistanceTypeBetweenTokens
   */
